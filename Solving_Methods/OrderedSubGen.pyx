...
cpdef subgen_rec(matrice_adja, max_ordre, combi_prec, taille_etud, combi_all):
...
cdef subgen_deg_decroiss(matrice_adja, atm_caract, min_ordre, max_ordre, crible):
    cdef int taille = len(matrice_adja)
